...
def classify_albumentations(
        ...
        perspective=0.15,
        p_perspective=0.45,
        hsv_h=0.025,  # image HSV-Hue augmentation (fraction)
        hsv_s=0.75,  # image HSV-Saturation augmentation (fraction)
        hsv_v=0.6,  # image HSV-Value augmentation (fraction)
        p_hsv=0.55,
        motion_blur_limit=[63, 91],  # motion blur
        p_motion_blur=0.7,
        gaussian_blur_limit=[51, 97],  # gaussian blur
        p_gaussian_blur=0.95,
        gaussian_noise_var_limit=[5.0, 95.0],  # gaussian noise
